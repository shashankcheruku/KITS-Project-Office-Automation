<%-- 
    Document   : maintenance_edit1
    Created on : 16 Feb, 2016, 5:11:14 PM
    Author     : Shashank
--%>
...
<html>
    ...
    <body>
        ...
        <%
            String ide=request.getParameter("sno");
            ...
            String sql="Update mntnce_entry set category='"+category+"', work_name='"+work_name+"', place='"+place+"', budget='"+budget+"', date_init=?, date_comp=? where sno='"+no+"'";
            PreparedStatement st=con.prepareStatement(sql);
            st.setDate(1, date_init);
            st.setDate(2, date_comp);
            st.execute();
        %>    
        <p style="margin-left: 50%">Edited</p>
