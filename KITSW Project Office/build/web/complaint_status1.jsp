<%-- 
    Document   : complaint_status1
    Created on : 13 Apr, 2016, 9:51:14 AM
    Author     : Shashank
--%>
...
<html>
    ...
    <body>
        ...
        String comp_status=request.getParameter("comp_status");
        
        Class.forName("oracle.jdbc.driver.OracleDriver");
        Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","SYSTEM","shashank");
        String sql="Update complaints set comp_status='"+comp_status+"' where sno='"+no+"'";
