<%-- 
    ...
    Created on : 13 Apr, 2016, 9:39:12 AM
    Author     : Shashank
--%>
...
<html>
    ...
    <body>
        ...
        %>
        <center>
        <form name="complaint_status" action="complaint_status1.jsp" method="POST">
            <table border="0">
                <tbody>
                    <tr>
                        <td>Ticket ID: </td>
                    ...
                    <tr>
                        <td>Status: </td>
                        <td><select name="comp_status">
                                <option>Reviewed by Project Officer</option>
                                <option>Forwarded to concerned person</option>
                                <option>Checked by concerned person</option>
