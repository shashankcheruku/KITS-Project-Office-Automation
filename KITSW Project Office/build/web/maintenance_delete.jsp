<%-- 
    Document   : maintenance_delete
    Created on : 16 Feb, 2016, 5:55:06 PM
    Author     : Shashank
--%>
...
<html>
    ...
    <body>
        ...
        <form name="maintenance_delete" method="POST">
            <%
                ...
                String sql="Delete from mntnce_entry where sno='"+no+"'";
                PreparedStatement st=con.prepareStatement(sql);
                st.executeQuery();
                %>    
        <p style="margin-left: 50%">Deleted</p>
