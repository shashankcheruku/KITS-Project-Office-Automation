<%-- 
    Document   : budget_allocate
    Created on : 6 Apr, 2016, 12:03:48 PM
    Author     : Shashank
--%>
...
<html>
    ...
    <center>
        <form name="budget_allocate" action="budget_allocate1.jsp" method="POST">
            <table border="0">
                <tbody>
                    <tr>
                        <td>From: </td>
                    ...
                    <tr>
                        <td>Total Budget: </td>
                        <td><input type="number" name="bud_total" min="1"/></td>
                    </tr>
                </tbody>
            </table>
