...
<html>
    ...
    <center>
        <form name="maintenance_display" action="maintenance_display1.jsp" method="POST">
            <table border="0">
                <tbody>
                    <tr>
                        <td>From: </td>
                        <td><input type="date" name="mntnce_from" /></td>
                    </tr>
                    <tr>
                        <td>To: </td>
                        <td><input type="date" name="mntnce_to" min="1" /></td>
                    </tr>
                </tbody>
            </table>
