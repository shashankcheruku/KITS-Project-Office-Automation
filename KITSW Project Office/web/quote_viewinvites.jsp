<%-- 
    Document   : quote_view
    Created on : 14 Apr, 2016, 5:32:24 PM
    Author     : Shashank
--%>
...
<html>
    ...
    <script lang="javascript">
        function viewQuotes(id){
            var f= document.getElementById("viewquotes");
            f.method="post";
            f.action="quote_view.jsp?id="+id;
            f.submit();            
        }
    </script>    
    <body>
    ...
    <!-- Nav wrapper end -->
        ...
        <form id="viewquotes" name="viewquotes"></form>
        <%
        Class.forName("oracle.jdbc.driver.OracleDriver");
        Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","SYSTEM","shashank");
        String sql="select * from quote_invite";
        ...
        <table border="1" style="width: 100%">
            <tbody>
                <tr>
                    ...
                    <th style="width: 16%">View Quotes</th>
                </tr>
            </tbody>
        </table>
                <%
        ...
        <table border="1" style="width: 100%">        
            <tbody>
                <tr>
                    ...
                    <td style="width: 16%"><input type="submit" onclick="viewQuotes(<%=rs.getString(1)%>);" name="view_quotes" value="View Quotes"></td>
                </tr>
            </tbody>
        </table>
