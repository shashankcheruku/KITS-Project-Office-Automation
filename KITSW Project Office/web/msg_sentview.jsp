<%-- 
    Document   : msg_sentview
    Created on : 14 Apr, 2016, 8:54:04 AM
    Author     : Shashank
--%>
...
<html>
    ...
    <!-- Nav wrapper end -->
        ...
        <%
            ...
            String sql="select msg_rec,msg,msg_date from msg_box where msg_sender='"+user_id+"'";
        ...
        <table border="1" style="width: 100%">
            <tbody>
                <tr>
                    <th style="width: 20%">Message Receiver</th>
        ...
        <table border="1" style="width: 100%">
            <tbody>
                <tr>
                    ...
                    <td style="width: 60%"><%=rs.getString(2)%></td>
                    <td style="width: 20%"><%=rs.getDate(3)%></td>
                </tr>
            </tbody>
        </table>
